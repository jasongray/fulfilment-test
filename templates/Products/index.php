        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th><?= $this->Paginator->sort('quantityOnHand') ?></th>
                    <th><?= $this->Paginator->sort('reorderThreshold') ?></th>
                    <th><?= $this->Paginator->sort('reorderAmount') ?></th>
                    <th><?= $this->Paginator->sort('deliveryLeadTime') ?></th>
