...
class StockMovementsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'details' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created' => '2020-02-16 03:20:17',
                'modified' => '2020-02-16 03:20:17',
            ],
        ];
        parent::init();
    }
