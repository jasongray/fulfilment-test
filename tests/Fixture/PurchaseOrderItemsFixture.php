...
class PurchaseOrderItemsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'purchaseOrderId' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        'costPerItem' => ['type' => 'decimal', 'length' => 10, 'precision' => 2, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'quantity' => 1,
                'costPerItem' => 1.5,
                'created' => '2020-02-16 03:20:11',
                'modified' => '2020-02-16 03:20:11',
            ],
        ];
        parent::init();
    }
